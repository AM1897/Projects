...
public class Main {
    ...
    private static void adminLogin() {
        ...
        try {
            ...
            // Hantera svaret, spara token om inloggningen lyckades
    ...
    private static void viewArticles() {
        ...
        try {
            ArticleClient articleClient = new ArticleClient("http://localhost:8080", null); // Använd null eller "" för authToken
